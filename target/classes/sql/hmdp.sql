...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '探店笔记表' ROW_FORMAT = Compact;
...
INSERT INTO `tb_blog` VALUES (23, 1, 1011, '主播带货评价', '/imgs/blogs/3/13/892a8dbe-5835-4d93-982a-839565ab0578.jpg,/imgs/blogs/8/8/97d8f795-9680-49ac-ba04-0e85aa91412e.jpg', '除了自身内功运营优化（环境，服务，口味，客户体验，互动等）提升以外，还可以从以下维度着手： 1）一：将门店星级纳入店长或相关员工 KPI 考核之中', 4, NULL, '2023-04-28 07:33:45', '2023-04-29 22:18:57');
INSERT INTO `tb_blog` VALUES (24, 2, 1016, '美味菜品，值得品尝', '/imgs/blogs/3/9/4df9efb0-147d-49a8-8bf2-de8a670dc0ba.jpg', '这个是....这是高汤焦掉发出的香味，确实这样的话就不用沾酱了，高汤渗入皮之后，适度的焦黄确实让味道更香了啊，不过应该还不止这样，也不能说粉粉的，能让皮的口感这么清爽，应该是还有用山芋吧，每吃一个都有新的口感，感受新的味道，内馅柔润的好像要化掉一样，每嚼一口嘴里就溢满了鲜汁，微麻微辣的风味，轻轻的刺激着舌头，乍看之下，这些煎饺好像没有什么特别，其实里头下了不少让人吃起来回味无穷的功夫，没想到煎饺也能达到如此美味的地步，这是我头一次吃到的滋味...', 4, NULL, '2023-04-29 18:56:50', '2023-04-29 22:18:58');
INSERT INTO `tb_blog` VALUES (25, 3, 1016, '旅途中欣赏景色和美食', '/imgs/blogs/12/14/7a18d596-405a-41ea-9137-a5fd36d2077e.jpg', '越秀公园是广州最大的城市公园之一，植物资源丰富，是重要的历史文化景点。非常适合喜欢自然、历史和文化的游客。游客可以在公园内欣赏优美的自然风光和重要的历史文化景点，了解广州的历史文化。', 2, NULL, '2023-05-03 17:29:25', '2023-05-03 18:47:09');
...
CREATE TABLE `tb_blog_comments`  (
  ...
  `update_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '探店笔记评价表' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `tb_follow` VALUES (2, 1016, 1, '2023-05-04 22:56:24');
INSERT INTO `tb_follow` VALUES (7, 1016, 1011, '2023-05-05 22:29:48');
INSERT INTO `tb_follow` VALUES (8, 1015, 1011, '2023-05-05 22:30:54');
INSERT INTO `tb_follow` VALUES (9, 1015, 1016, '2023-05-05 22:31:00');
...
-- ----------------------------
INSERT INTO `tb_seckill_voucher` VALUES (11, 99, '2023-04-01 20:00:48', '2023-03-31 20:00:52', '2023-04-05 20:01:01', '2023-04-02 22:23:56');
INSERT INTO `tb_seckill_voucher` VALUES (15, 99, '2023-05-03 15:09:43', '2023-05-19 16:00:00', '2023-06-05 15:59:00', '2023-05-03 15:10:52');
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_shop
-- ----------------------------
INSERT INTO `tb_shop` VALUES (1, '302茶餐厅', 1, 'https://qcloud.dpfile.com/pc/jiclIsCKmOI2arxKN1Uf0Hx3PucIJH8q0QSz-Z8llzcN56-_QiKuOvyio1OOxsRtFoXqu0G3iT2T27qat3WhLVEuLYk00OmSS1IdNpm8K8sG4JN9RIm2mTKcbLtc2o2vfCF2ubeXzk49OsGrXt_KYDCngOyCwZK-s3fqawWswzk.jpg,https://qcloud.dpfile.com/pc/IOf6VX3qaBgFXFVgp75w-KKJmWZjFc8GXDU8g9bQC6YGCpAmG00QbfT4vCCBj7njuzFvxlbkWx5uwqY2qcjixFEuLYk00OmSS1IdNpm8K8sG4JN9RIm2mTKcbLtc2o2vmIU_8ZGOT1OjpJmLxG6urQ.jpg', '万科中心', '翡翠路锦昌文华苑29号', 120.149192, 30.316078, 80, 0000004215, 0000003035, 37, '10:00-22:00', '2021-12-22 10:10:39', '2022-01-13 09:32:19');
...
INSERT INTO `tb_shop` VALUES (15, '莱顿舞厅', 1, 'https://www.maoyan.com/films/1462626?utm_source=meituanweb', '中国大陆', '蜀山区长江西路与肥西路交叉口之心城商业中心7楼（近国购广场）', 110, 30, 64, 0000018000, 0000001000, 95, '16:00-16:55', '2023-02-05 15:04:09', '2023-06-22 22:56:29');
INSERT INTO `tb_shop` VALUES (16, '上海凯爵商务会所', 1, 'https://www.maoyan.com/films/1366696?utm_source=meituanweb', '中国大陆', '蜀山区高新区长宁大道1888号砂之船艺术商业广场奥特莱斯3层', 110, 30, 39, 0000015000, 0000000600, 90, '17:35-20:38', '2023-02-05 15:07:22', '2023-06-22 22:57:25');
...
CREATE TABLE `tb_shop_type`  (
  ...
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商户类型表' ROW_FORMAT = Compact;
...
INSERT INTO `tb_shop_type` VALUES (5, '按摩·足疗', '/types/amzl.png', 6, '2021-12-22 20:19:27', '2023-06-22 15:58:12');
INSERT INTO `tb_shop_type` VALUES (6, '美容SPA', '/types/spa.png', 5, '2021-12-22 20:19:35', '2023-06-22 15:58:08');
INSERT INTO `tb_shop_type` VALUES (7, '亲子游乐', '/types/qzyl.png', 7, '2021-12-22 20:19:53', '2021-12-23 11:24:31');
INSERT INTO `tb_shop_type` VALUES (8, '酒吧', '/types/jiuba.png', 9, '2021-12-22 20:20:02', '2023-06-22 15:58:15');
INSERT INTO `tb_shop_type` VALUES (9, '轰趴馆', '/types/hpg.png', 8, '2021-12-22 20:20:08', '2023-06-22 15:58:19');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1016 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;
...
INSERT INTO `tb_user` VALUES (4, '13456789011', '', 'user_slxaxy2au9f3tanffaxr', '/imgs/icons/kkjtbcr.jpg', '2022-01-07 12:07:53', '2023-04-03 10:22:11');
INSERT INTO `tb_user` VALUES (1011, '19956570011', '', 'user_1m27xn', '/imgs/icons/kkjtbcr.jpg', '2023-01-12 23:00:32', '2023-04-03 10:22:14');
INSERT INTO `tb_user` VALUES (1013, '19955347574', '', 'user_gl5pco', '/imgs/icons/kkjtbcr.jpg', '2023-02-04 09:34:16', '2023-04-03 10:22:16');
INSERT INTO `tb_user` VALUES (1015, '19915147978', '', 'user_cweh0x', '/imgs/icons/kkjtbcr.jpg', '2023-02-26 22:06:51', '2023-04-03 10:22:20');
INSERT INTO `tb_user` VALUES (1016, '19915637707', '', 'user_ajin0o', '/imgs/icons/user6-icon.jpg', '2023-04-12 21:41:06', '2023-06-01 07:35:34');
...
-- ----------------------------
INSERT INTO `tb_voucher` VALUES (1, 1, '50元代金券', '周一至周日均可使用', '全场通用\\n无需预约\\n可无限叠加\\不兑现、不找零\\n仅限堂食', 4750, 5000, 0, 1, '2022-01-04 09:42:39', '2023-03-21 23:41:40');
INSERT INTO `tb_voucher` VALUES (11, 1, '300元代金券', '周一至周五均可使用', '全店2件\\起批24小时发货\\退货包运费\\全场包邮七天退换\\', 30000, 1500, 1, 1, '2023-03-22 00:05:11', '2023-03-29 22:26:26');
INSERT INTO `tb_voucher` VALUES (15, 1, '300元代金券', '周一至周五均可使用', '全店2件\\起批24小时发货\\退货包运费\\全场包邮七天退换\\', 300000, 15000, 1, 1, '2023-05-03 15:09:43', '2023-05-03 15:09:43');
...
-- ----------------------------
INSERT INTO `tb_voucher_order` VALUES (45507119826337799, 1016, 15, 1, 1, '2023-05-03 15:10:52', NULL, NULL, NULL, '2023-05-03 15:10:52');
