...
| 
 | 属性 | 备注 |
| --- | --- | --- |
| @ApiOperationSupport() | 添加作者增强注解 | author = "" |
| @ApiOperation() | 扩展属性方法注解 | value = "写文档注释我是认真的" |
| @Api() | Controller模块 | tags = "2.0.3版本-20200312" |
| @ApiSupport() | 所有的接口添加作者 | author = "",order = 284 |
| @ApiModelProperty() | 实体对象参数名称 | value="姓名",example="张飞" |
| @ApiParam() | 请求参数 | name = "title", value = "公告标题", required = true |
