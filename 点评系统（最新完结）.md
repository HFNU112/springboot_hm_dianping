...
| 
 | **请求URI** | **请求方式** | **请求参数** | **响应值** |
| --- | --- | --- | --- | --- |
| 新增普通券 | /voucher | POST | Voucher:{"shopId":"",
   "title":"",
   "subTitle":"",
   "rules":"",
   "payValue":"",
   "actualValue":"",
   "type":""} | "success": true |
| 新增秒杀券 | /voucher/seckill | POST | Voucher:{
	"shopId": "",
	"title": "",
	"subTitle": "",
	"rules": "",
...
| 查询店铺的优惠券列表 | /voucher/list/{shopId} | GET | shopId | List<Voucher>:{
	"shopId": "",
	"title": "",
	"subTitle": "",
	"rules": "",
...
| 新增订单 | /voucher-order/seckill/{id} | POST | voucherId | "success": true |
